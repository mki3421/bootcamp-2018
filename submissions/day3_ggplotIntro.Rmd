...
grouped %>%
  ...
  ggplot() +
    ...
    labs(title="Average Hourly Output by Source Group", x="Time of day", y="Mean Hourly Output", caption="Source: California Dept. of Energy")
...
grouped %>%
  ...
  ggplot() +
    ...
    labs(title="Average Hourly Output by Source Group", x="Time of day", y="Mean Proportion of Total Hourly Output", caption="Source: California Dept. of Energy")
```
